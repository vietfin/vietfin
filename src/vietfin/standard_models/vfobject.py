...
class VfObject(BaseModel, Generic[T]):
    ...
    def __repr__(self) -> str:
        ...
        # Iterates through the items from calling self.model_dump() 
        # which would return a dictionary of the model attributes and values.
        # For each key-value pair, it formats it as a string with the key, value 
        # and limits it to 83 chars with ellipses if longer.
        # Joins these formatted items with newlines to generate a multi-line string.
        # The class name is prepended on the first line for context.
        items = [
